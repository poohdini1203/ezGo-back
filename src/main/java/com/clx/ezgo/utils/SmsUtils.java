...
public class SmsUtils {
    ...
    public static void sendShortMessage(String templateCode, String phoneNum,String param)  {
        try {
            ...
            req.setSmsSdkAppid("1400499762");
            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，可登录 [短信控制台] 查看签名信息 */
            req.setSign("poohdini");
    ...
    public static void main(String[] args) {
        ...
        jsonObject.put("varificationCode",123);
        jsonObject.put("ok",456);
        System.out.println(jsonObject.toJSONString());
        String templateID = "905725";
        String phoneNumbers = "18780075098";
        String param="666666";
